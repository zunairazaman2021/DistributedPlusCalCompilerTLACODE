...
public class AST
  { public static AST.Uniprocess   UniprocessObj   ;
    ...
    public static AST.Thread       threadObj             ; //ZZ Code
...
/***************************** UTILITY METHODS ****************************/
    ...
    //end ZZ Code 
	  ...
	  public String toString() {
		  return
				  ...
				  " id     |-> " + id.toString() + "," + NewLine() +
				  //ZZ Code
          " replicate     |-> " + replicate.toString() + "," + NewLine() +
				  //End ZZ Code
    		  Indent(" body   |-> ") + 
				  VectorToSeqString(body) + "]" + ", " + 
          EndIndent() + 
  ...
  public static class ReplicatedThread extends AST{
	  public String    name  = "" ;
	  public Vector  minusLabels = new Vector();
	  public Vector  plusLabels = new Vector();
	  public Vector  proceduresCalled = new Vector();
